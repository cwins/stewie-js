...
export async function webResponseToNodeResponse(webRes: Response, serverRes: ServerResponse): Promise<void> {
...
export function createNodeHandler(app: StewieApp): (req: IncomingMessage, res: ServerResponse) => Promise<void> {
