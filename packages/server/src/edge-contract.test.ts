...
describe('edge: Web API availability', () => {
  it('Request is available', () => { expect(typeof Request).toBe('function') })
  it('Response is available', () => { expect(typeof Response).toBe('function') })
  it('ReadableStream is available', () => { expect(typeof ReadableStream).toBe('function') })
  it('URL is available', () => { expect(typeof URL).toBe('function') })
  it('Headers is available', () => { expect(typeof Headers).toBe('function') })
})
