...
if (isProd) {
  ...
  // Run `pnpm build` first to generate them.
  // ---------------------------------------------------------------------------
  ...
  server.listen(PORT, () => {
    console.log(`Stewie SSR demo (production) at http://localhost:${PORT}`)
  })
} else {
  // ---------------------------------------------------------------------------
  // Development: Vite dev server as middleware — provides HMR, asset serving,
  // and module transforms. Our handler does SSR for page routes.
  // ---------------------------------------------------------------------------
  ...
  server.listen(PORT, () => {
    console.log(`Stewie SSR demo (dev) at http://localhost:${PORT}`)
  })
}
