  ...
  return (
    <div class="container" data-testid="dashboard">
      ...
      <div class="grid" data-testid="project-grid">
        ...
        <div class="card add-card" data-testid="new-project-card" onClick={() => router.navigate('/project/create')}>
          + New Project
        </div>
      </div>
    </div>
      ...
      <form onSubmit={handleSubmit} data-testid="edit-task-form">
        ...
        <div class="input-group" style="display: flex; align-items: center; gap: 0.5rem;">
          <input
            ...
            style="width: auto;"
          />
          <label for="edit-task-completed" style="margin: 0;">
            Completed
          </label>
        </div>
    ...
    <div class="container" data-testid="create-task">
      ...
      <div class="form-card">
        ...
        <form onSubmit={handleSubmit} data-testid="create-task-form">
          ...
          <button type="button" class="btn-secondary" onClick={() => router.navigate(`/project/${projectId}`)}>
            Cancel
          </button>
        </form>
      </div>
...
export function App({ initialUrl }: { initialUrl?: string } = {}): JSXElement {
  ...
  const serverData = (registry?.get('appData') as AppData | undefined) ?? defaultData;
