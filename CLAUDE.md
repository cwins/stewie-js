...
- **Diagnostics — partial** — `DIAGNOSTICS.md` blueprints ~52 `STW###` codes; ~21 are implemented in package source today (STW001-007, 010, 011, 014, 022, 030, 040, 042, 052, 063, 073, 083, 092, 094, 095). The remaining ~30 (compiler rules + dev-runtime warnings, per-code silencing, docs links) are not yet built.
